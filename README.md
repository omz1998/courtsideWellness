...
Classes start Monday 12 October 2026. `FIRST_BOOKABLE_DATE` in `js/booking.js` stops the date picker from offering anything earlier. Once that date passes it has no effect.
